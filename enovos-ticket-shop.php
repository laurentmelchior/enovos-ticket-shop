...
define('ENOVOS_TICKET_SHOP_VERSION', '0.7.21');
...
require_once ENOVOS_TICKET_SHOP_DIR . 'includes/class-enovos-digest-unsubscribe.php';
require_once ENOVOS_TICKET_SHOP_DIR . 'includes/class-enovos-digest-admin.php';
require_once ENOVOS_TICKET_SHOP_DIR . 'includes/class-enovos-new-products.php';
...
require_once ENOVOS_TICKET_SHOP_DIR . 'includes/class-enovos-order-delivery.php';
